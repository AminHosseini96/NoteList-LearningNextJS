...
import './globals.css';
import { HeaderIndex } from '@/app/components/Header/Header.index';
...
export default function Home() {
  return (
    <main className='flex min-h-screen flex-col items-center justify-between'>
      <HeaderIndex />
      <div className='px-10 mb-32 mt-36 h flex flex-row text-center w-full'>
        <div className={'h-full w-4/12 flex p-6 rounded-xl border-2 border-cyan-950'}>
          <Button onClick={() => {}} label={'new note'} style={{ width: '100%', justifyContent: 'flex-end' }} />
        </div>
